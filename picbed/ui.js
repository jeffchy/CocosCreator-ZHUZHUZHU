    ...
    if (!isImg) {
        ...
        $(img).on('load', function() {
            ...
            if (!(ie && ie <= 9)) {
                ...
                var infoArea = $('<div/>');
                var infoInner = '<div>file info</div>'+'<div>格式：<span class="origin-format">' + imageInfo.format + '</span></div>' +
